        ...
        <div className="container-custom relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <div className="propaganda-box transform skew-x-0">
                <div className="number-callout mb-1">14</div>
                <div className="text-sm uppercase font-bold text-white">{language === 'tr' ? 'Haziran 2025' : 'June 2025'}</div>
                <div className="text-xs text-accent-500 mt-1">{t('dataHub.lastUpdate')}</div>
              </div>
              
              <div className="propaganda-box transform skew-x-0">
                <div className="number-callout mb-1 text-accent-500">421</div>
                <div className="text-sm uppercase font-bold text-accent-500">ppm CO₂</div>
                <div className="text-xs text-accent-500 mt-1">{language === 'tr' ? 'Atmosferik seviye' : 'Atmospheric level'}</div>
              </div>
              
              <div className="propaganda-box transform skew-x-0">
                <div className="number-callout mb-1 text-red-500">+1.2°C</div>
                <div className="text-sm uppercase font-bold text-red-500">{language === 'tr' ? 'Küresel Isınma' : 'Global Warming'}</div>
                <div className="text-xs text-accent-500 mt-1">{language === 'tr' ? '1850-1900\'e göre' : 'vs 1850-1900'}</div>
              </div>
            </div>
          </div>
        </div>
